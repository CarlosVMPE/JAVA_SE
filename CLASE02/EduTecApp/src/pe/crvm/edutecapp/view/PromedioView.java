...
public class PromedioView extends javax.swing.JFrame {
    ...
    private void cargarPaneles(){
        jTabbedPane1.add("2 Numeros",new Panel2Num());
        jTabbedPane1.add("3 Numeros",new Panel3Num());
        jTabbedPane1.add("4 Numeros",new Panel4Num());
        jTabbedPane1.add("5 Numeros",new Panel5Num());
    }
